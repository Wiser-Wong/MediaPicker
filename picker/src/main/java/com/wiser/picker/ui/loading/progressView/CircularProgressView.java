package com.wiser.picker.ui.loading.progressView;
...
public class CircularProgressView extends View {
	...
	/**
	 * Sets whether this CircularProgressView is indeterminate or not. It will reset
	 * the animation if the mode has changed.
	 * 
	...
	/**
	 * Starts the progress bar animation. (This is an alias of resetAnimation() so
