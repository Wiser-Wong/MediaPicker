...
public class CameraTool {
	 ...
	 * @return
	 */
	public static File skipCamera(Activity activity) {
		...
		if (cameraIntent.resolveActivity(activity.getPackageManager()) != null) {
			...
			if (mTmpFile != null && mTmpFile.exists()) {
				...
				activity.startActivityForResult(cameraIntent, MediaConstants.CAMERA_REQUEST_CODE);
			}
		}
		return mTmpFile;
	}
	...
	// 图片裁剪
	public static Uri cropPhoto(Activity activity, Uri uri, File imgFile, int cropWidth, int cropHeight, int requestCode) {
		if (activity == null) return null;
		Uri mCutUri;
